...
public partial class EnemyAI : MonoBehaviour
{
    ...
    [SerializeField] private List<AbstractCharacter> detectedCharacterList = new List<AbstractCharacter>();
    ...
    public bool CheckDetection(AbstractCharacter target)
    {
    ...
    private void FullDetection()
    {
        ...
        foreach (Collider item in candidates)
        {
            ...
            AbstractCharacter possibleTarget = item.GetComponent<AbstractCharacter>();
